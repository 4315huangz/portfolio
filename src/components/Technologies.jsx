            ...
            <motion.div 
              ...
              className='flex flex-wrap items-center justify-center gap-4'>
                ...
                <motion.div 
                  ...
                  animate='animate'
                  className='rounded-2xl border-4 border-neutral-800 p-4'>
                    <SiHibernate className='text-7xl text-black-200'/>
                </motion.div>
                <motion.div 
                  ...
                  animate='animate'
                  className='rounded-2xl border-4 border-neutral-800 p-4'>
                    <FaAws className='text-7xl text-red-400'/>
                </motion.div>
                <motion.div 
                  variants={iconVariants(2)}
                  initial='initial'
                  animate='animate'
                  className='rounded-2xl border-4 border-neutral-800 p-4'>
                    <DiGoogleCloudPlatform className='text-7xl text-blue-400'/>
                </motion.div>
                <motion.div 
                  variants={iconVariants(3)}
                  initial='initial'
                ...
                <motion.div 
                  ...
                  animate='animate'
                  className='rounded-2xl border-4 border-neutral-800 p-4'>
                    <SiFlyway className='text-7xl text-red-400'/>
                </motion.div>
            </motion.div>
    </div>
  )
